...
Portaldot/
  bin/
    linux-x64/       — Linux x86_64 substrate-contracts-node binary
    macos-arm64/     — macOS Apple Silicon node binary (placeholder)
    macos-x64/       — macOS Intel node binary (placeholder)
    windows-x64/     — Windows x64 node binary (placeholder)
