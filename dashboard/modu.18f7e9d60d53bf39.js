...
`,K=c.memo((function(e){return(0,o.jsx)(_,{...e})}))},72152:(e,t,s)=>{s.d(t,{r_:()=>j,K0:()=>z,CU:()=>D,lB:()=>C});var r=s(47451);const n={name:"@Portaldot/react-qr",path:new URL("file:///home/runner/work/apps/apps/node_modules/@Portaldot/react-qr/packageInfo.js").pathname.substring(0,new URL("file:///home/runner/work/apps/apps/node_modules/@Portaldot/react-qr/packageInfo.js").pathname.lastIndexOf("/")+1),type:"esm",version:"3.16.7"};(0,r.E)(n,null,[]);var a=s(52322),i=s(2784),o=s(33403),c=s(69516);const l=s(4133);l.stringToBytes=e=>e;var u=s(31383),m=s(51330),d=s(46610),p=s(54371),h=s(94175);const f="secret",y=new Uint8Array([83]),g=new Uint8Array([1]),x=(new Uint8Array([0]),new Uint8Array([1]),new Uint8Array([2]),new Uint8Array([3]),new Uint8Array([0]));function v(e){return new Uint8Array([e>>8,255&e])}function w(e){if(!e)return{height:"auto",width:"100%"};const t=(0,p.H)(e)?e:`${e}px`;return{height:t,width:t}}function k(e){const t=l(0,"M");return t.addData(e,"Byte"),t.make(),t.createDataURL(16,0)}const b=u.zo.div`
  .ui--qr-Display {
    height: 100%;
    width: 100%;
