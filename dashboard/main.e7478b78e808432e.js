...
`,T=g.memo((function({children:e,className:n="",icon:t,isBottom:i=!1,isDev:o,isFull:a=!1,type:s}){const[l,c]=(0,U.O)(),d=(0,g.useCallback)((()=>{o&&localStorage.setItem("dev:notification",(new Date).toString()),c()}),[o,c]);return(0,g.useEffect)((()=>{const e=localStorage.getItem("dev:notification");if(e){const n=new Date(e);n.setMonth(n.getMonth()+1),n.getTime()<=(new Date).getTime()?localStorage.removeItem("dev:notification"):c()}}),[c]),l?null:(0,r.jsx)(F,{className:`${n} ${"error"===s?"isError":"isInfo"} ${i?"isBottom":"isTop"} ${a?"isFull":"isPartial"}`,children:(0,r.jsxs)("div",{className:"content",children:[(0,r.jsx)(N.JO,{className:"contentIcon",icon:t,size:"2x"}),(0,r.jsx)("div",{className:"contentItem",children:e}),(0,r.jsx)(N.zx,{className:"closeIcon",icon:"times",isBasic:!0,isCircular:!0,onClick:d})]})})})),z=N.zo.div`
...
`,ft=g.memo((function({className:e}){const n=(0,O.TH)(),{t}=Z(),{api:i,isApiConnected:o,isApiReady:a,isDevelopment:s}=(0,E.h)(),{queueAction:l}=(0,Qn.L)(),{Component:c,display:{needsApi:d,needsApiCheck:p,needsApiInstances:u},icon:m,name:h,text:f}=(0,g.useMemo)((()=>{const e=n.pathname.slice(1)||"";return Yn(t).find((n=>n&&e.startsWith(n.name)&&(s||!n.display.isDevelopment)))||gt}),[s,n,t]),x=(0,g.useMemo)((()=>d?a&&o?it(i,d,u,p):null:[]),[i,o,a,d,p,u]);return(0,r.jsx)(ht,{className:e,children:x?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(g.Suspense,{fallback:"...",children:(0,r.jsx)(N.SV,{trigger:h,children:(0,r.jsx)(et.m.Provider,{value:{icon:m,text:f},children:x.length?(0,r.jsx)(st,{basePath:`/${h}`,location:n,missingApis:x,onStatusChange:l}):(0,r.jsx)(c,{basePath:`/${h}`,location:n,onStatusChange:l})})})}),(0,r.jsx)(mt,{})]}):(0,r.jsxs)("div",{className:"connecting",children:[(0,r.jsx)(at,{}),(0,r.jsx)(N.$j,{label:t("Initializing connection")})]})})}));var xt=t(41411),vt=t(12176),yt=t(95689),kt=t(68058),bt=t(10072),wt=t(70676);const Ct=N.zo.div`
...
`,qt=g.memo((function({className:e="",offset:n,onClose:t}){const{t:i}=Z(),o=(0,c.Rf)(i),{apiEndpoint:a,isLocalFork:s}=(0,E.h)(),[d,u]=(0,g.useState)((()=>Nt())),[m,h]=(0,g.useState)((()=>Ut(o))),[{apiUrl:f,groupIndex:x,hasUrlChanged:v,isUrlValid:y},k]=(0,g.useState)((()=>Tt(p.X.get().apiUrl,m))),[b,w]=(0,g.useState)((()=>Ft())),[C,j]=(0,g.useState)((()=>function(e){return Object.entries(l().get(Zt)||{}).filter((([n,t])=>e.some((({networks:e})=>e.some((({name:e,providers:r})=>e===n&&r.some((({url:e})=>e===t)))))))).reduce(((e,[n,t])=>({...e,[n]:t})),{})}(m))),A=(0,g.useRef)(null),I=(0,g.useMemo)((()=>{let e=!1;return o.some((n=>n.value===f&&(e=!0,!0))),e}),[f,o]),R=(0,g.useMemo)((()=>{let e=!1;return b.some((n=>n===f&&(e=!0,!0))),e}),[f,b]),$=(0,g.useCallback)((e=>k((n=>({...n,groupIndex:e})))),[]),U=(0,g.useCallback)((e=>{(e=>{try{const n=e.chainName,t={paraId:e.paraId??-1,relay:e.relay??"Unknown"},r=Nt(),i=r[n]??[];let o;o=i.some((e=>e.relay===t.relay&&e.paraId===t.paraId))?i.filter((e=>e.relay!==t.relay||e.paraId!==t.paraId)):[...i,t];const a={...r};0===o.length?delete a[n]:a[n]=o,localStorage.setItem(At,JSON.stringify(a))}catch{}})(e),u(Nt()),h(Ut((0,c.Rf)(i)))}),[i]),F=(0,g.useCallback)((()=>{if(!R)return;const e=b.filter((e=>e!==f));try{localStorage.setItem(bt.ie,JSON.stringify(e)),h(Ut((0,c.Rf)(i))),w(Ft())}catch(e){console.error(e)}}),[f,R,b,i]),T=(0,g.useCallback)(((e,n)=>{j((t=>{const r={...t,[e]:n};return l().set(Zt,r),r})),k((e=>({...Tt(n,m),groupIndex:e.groupIndex})))}),[m]),z=(0,g.useCallback)((e=>{(0,wt._)(e)||(e=kt.ZP.toASCII(e)),k((n=>({...Tt(e,m),groupIndex:n.groupIndex})))}),[m]),q=(0,g.useCallback)((()=>{l().set("localFork",""),p.X.set({...p.X.get(),apiUrl:f}),window.location.assign(`${window.location.origin}${window.location.pathname}?rpc=${encodeURIComponent(f)}${window.location.hash}`),v||window.location.reload(),t()}),[f,t,v]),W=(0,g.useCallback)((()=>{l().set("localFork",f),p.X.set({...p.X.get(),apiUrl:f}),window.location.assign(`${window.location.origin}${window.location.pathname}?rpc=${encodeURIComponent(f)}${window.location.hash}`),v||window.location.reload(),t()}),[f,t,v]),O=(0,g.useCallback)((()=>{try{localStorage.setItem(bt.ie,JSON.stringify([...b,f])),q()}catch(e){console.error(e)}}),[q,f,b]),M=(0,g.useMemo)((()=>function(e,n,t,r){return e?!n.startsWith("light://")&&!t:!r}(v,f,y,s)),[v,f,y,s]),P=(0,g.useMemo)((()=>function(e,n,t,r){return e?!!n.startsWith("light://")||!t:!!r}(v,f,y,s)),[v,f,y,s]);return(0,r.jsx)(zt,{buttons:(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(N.zx,{icon:"code-fork",isDisabled:P,label:i("Fork Locally"),onClick:W,tooltip:"fork-locally-btn"}),(0,r.jsx)(N.zx,{icon:"sync",isDisabled:M,label:i("Switch"),onClick:q})]}),className:e,offset:n,onClose:t,position:"left",sidebarRef:A,children:m.map(((e,n)=>(0,r.jsx)($t,{affinities:C,apiUrl:f,favoriteChains:d,highlightColor:a?.ui.color||S.B,index:n,isSelected:x===n,setApiUrl:T,setGroup:$,toggleFavoriteChain:U,value:e,children:e.isDevelopment&&(0,r.jsxs)("div",{className:"endpointCustomWrapper",children:[(0,r.jsx)(N.II,{className:"endpointCustom",isError:!y,isFull:!0,label:i("custom endpoint"),onChange:z,value:f}),R?(0,r.jsx)(N.zx,{className:"customButton",icon:"trash-alt",onClick:F}):(0,r.jsx)(N.zx,{className:"customButton",icon:"save",isDisabled:!y||I,onClick:O})]})},n)))})})),Et=N.zo.div`
  box-sizing: border-box;
...
`,Wt=g.memo((function({className:e}){const{api:n,isApiReady:t}=(0,E.h)(),i=(0,ct.W7)(t&&n.rpc.state.subscribeRuntimeVersion),{ipnsChain:o}=(0,d.g)(),[a,s]=(0,U.O)(),l=!o;return(0,r.jsxs)(Et,{className:e,children:[(0,r.jsxs)("div",{className:`apps--SideBar-logo-inner${l?" isClickable":""} highlight--color-contrast`,onClick:s,children:[(0,r.jsx)(N.Mj,{}),(0,r.jsxs)("div",{className:"info media--1000",children:[(0,r.jsx)(vt.Z,{className:"chain"}),i&&(0,r.jsxs)("div",{className:"runtimeVersion",children:[i.specName.toString(),"/",i.specVersion.toNumber()]}),(0,r.jsx)(yt.Z,{className:"bestNumber",label:"#"})]}),l&&(0,r.jsx)(N.JO,{className:"dropdown",icon:a?"caret-right":"caret-down"})]}),a&&(0,r.jsx)(qt,{onClose:s})]})})),Ot=()=>0,Mt=N.zo.li`
  cursor: pointer;
  position: relative;
  white-space: nowrap;
...
`,Pt=g.memo((function({className:e="",classNameText:n,isLink:t,isToplevel:i,route:{Modal:o,href:a,icon:s,name:l,text:c,useCounter:d=Ot}}){const[p,u]=(0,U.O)(),m=d();return(0,r.jsxs)(Mt,{className:`${e} ui--MenuItem ${m?"withCounter":""} ${t?"isLink":""} ${i?"topLevel highlight--color-contrast":""}`,children:[(0,r.jsxs)("a",{href:o?void 0:a||`#/${l}`,onClick:o?u:void 0,rel:"noopener noreferrer",target:a?"_blank":void 0,children:[(0,r.jsx)(N.JO,{icon:s}),(0,r.jsx)("span",{className:n,children:c}),!!m&&(0,r.jsx)(N.Ct,{color:"white",info:m})]}),o&&p&&(0,r.jsx)(o,{onClose:u})]})})),Bt="rgba(34, 36, 38, 0.12)",Dt="5px",Ht=N.zo.li`
  cursor: pointer;
  position: relative;
  ...
  .groupMenu {
    border-radius: 0.25rem;
    box-shadow: 0 ${Dt} ${Dt} -${Dt} ${Bt}, ${Dt} 0 ${Dt} -${Dt} ${Bt}, -${Dt} 0 ${Dt} -${Dt} ${Bt};
    display: none;
    margin: 0;
    overflow: hidden;
    padding: 0;
...
`,Lt=g.memo((function({className:e="",isActive:n,name:t,routes:i}){return 1===i.length&&"settings"===i[0].group?(0,r.jsx)(Pt,{className:n?"isActive":"",classNameText:"smallHide",isToplevel:!0,route:i[0]}):(0,r.jsxs)(Ht,{className:`${e} ${n?"isActive":""}`,children:[(0,r.jsxs)("div",{className:"groupHdr "+(n?"":"highlight--color-contrast"),children:[(0,r.jsx)("span",{className:"smallHide",children:t}),(0,r.jsx)(N.JO,{className:"smallShow",icon:i[0].icon}),(0,r.jsx)(N.JO,{icon:"caret-down"})]}),(0,r.jsx)("ul",{className:"groupMenu",children:i.map((e=>(0,r.jsx)(Pt,{route:e},e.name)))})]})}));var Jt=t(54194),Xt=t(39082),Vt=t(52727);const _t=`apps v${Jt.b.version.replace("-x","")}`,Gt=N.zo.div`
...
`,Kt=g.memo((function({className:e=""}){const{api:n,isApiReady:t}=(0,E.h)();return(0,r.jsxs)(Gt,{className:`${e} media--1400 highlight--color-contrast ui--NodeInfo`,children:[t&&(0,r.jsxs)("div",{className:"node",children:[(0,r.jsx)(Xt.Z,{})," ",(0,r.jsx)(Vt.Z,{label:"v"})]}),(0,r.jsx)("div",{children:n.libraryInfo.replace("@Portaldot/","")}),(0,r.jsx)("div",{children:_t})]})}));const Yt=N.zo.div`
  width: 100%;
  padding: 0;
  z-index: 220;
  position: relative;
...
`,Qt=g.memo((function({className:e=""}){const{t:n}=Z(),{allAccounts:t,hasAccounts:i}=(0,lt.x)(),o=(0,E.h)(),{allowTeleport:a}=(0,xt.M)(),s=(0,ct.W7)(o.isApiReady&&o.api.query.sudo?.key),l=(0,O.TH)(),c=(0,g.useRef)(function(e){return[{href:"https://github.com/Portaldot-js/apps",icon:"code-branch",name:"github",text:e("nav.github","GitHub",{ns:"apps-routing"})},{href:"https://wiki.Portaldot.network",icon:"book",name:"wiki",text:e("nav.wiki","Wiki",{ns:"apps-routing"})}]}(n)),d=(0,g.useRef)(Yn(n)),p=(0,g.useRef)({accounts:n("Accounts"),developer:n("Developer"),files:n("Files"),governance:n("Governance"),network:n("Network"),settings:n("Settings")}),u=(0,g.useMemo)((()=>!!s&&t.some((e=>s.eq(e)))),[t,s]),m=(0,g.useMemo)((()=>function(e,n,t,r,i,o){return Object.values(e.reduce(((e,t)=>(e[t.group]?e[t.group].routes.push(t):e[t.group]={name:n[t.group],routes:[t]},e)),{})).map((({name:e,routes:n})=>({name:e,routes:n.filter((({display:e})=>function({api:e,isApiConnected:n,isApiReady:t,isDevelopment:r},i,o,a,{isDevelopment:s,isHidden:l,needsAccounts:c,needsApi:d,needsApiCheck:p,needsApiInstances:u,needsSudo:m,needsTeleport:g}){return!(l||c&&!o||d&&(!t||!n||m&&!a||g&&!i||!r&&s||0!==it(e,d,u,p).length))}(t,r,i,o,e)))}))).filter((({routes:e})=>e.length))}(d.current,p.current,o,a,i,u)),[a,o,i,u]),h=(0,g.useMemo)((()=>d.current.find((({name:e})=>l.pathname.startsWith(`/${e}`)))||null),[l]);return(0,r.jsx)(Yt,{className:`${e}${o.isApiReady&&o.isApiConnected?"":" isLoading"} highlight--bg`,children:(0,r.jsxs)("div",{className:"menuContainer",children:[(0,r.jsxs)("div",{className:"menuSection",children:[(0,r.jsx)(Wt,{}),(0,r.jsx)("ul",{className:"menuItems",children:m.map((({name:e,routes:n})=>(0,r.jsx)(Lt,{isActive:!!h&&h.group===e.toLowerCase(),name:e,routes:n},e)))})]}),(0,r.jsx)("div",{className:"menuSection media--1200",children:(0,r.jsx)("ul",{className:"menuItems",children:c.current.map((e=>(0,r.jsx)(Pt,{isLink:!0,isToplevel:!0,route:e},e.name)))})}),(0,r.jsx)(Kt,{className:"media--1400"})]})})})),er=window.location.host.startsWith("Portaldot.js.org"),nr=(0,c.Rf)((()=>"")).map((e=>e.dnslink)).reduce(((e,n)=>(n&&!e.includes(n)&&e.push(n),e)),[]),tr=g.memo((function({className:e}){const{t:n}=Z(),{systemChain:t}=(0,E.h)(),i=(0,g.useMemo)((()=>{const e=t?.toLowerCase();return e&&nr.includes(e)?`https://${e}.dotapps.io`:"https://dotapps.io"}),[t]);return er?(0,r.jsx)(T,{className:e,icon:"link",isBottom:!0,isDev:!0,isFull:!0,type:"info",children:(0,r.jsxs)("div",{children:[n("You are connected to the development instance of the UI. For a fully decentralized experience, you are encouraged to use the IPFS deployed version as the canonical URL: "),(0,r.jsx)("a",{href:i,rel:"noreferrer",target:"_blank",children:i.replace("https://","")})]})}):null})),rr=g.memo((function({className:e}){const{t:n}=Z(),{isLocalFork:t}=(0,E.h)();return t?(0,r.jsx)(T,{className:e,icon:"link",isBottom:!0,isFull:!0,type:"info",children:(0,r.jsxs)("div",{children:[n("Local fork powered by "),(0,r.jsx)("a",{href:"https://github.com/AcalaNetwork/chopsticks",rel:"noreferrer",target:"_blank",children:"Chopsticks"}),"."]})}):null})),ir=N.zo.div`
  position: fixed;
  bottom: 0.75rem;
  right: 0.75rem;
  left: 0.75rem;
...
`,or=g.memo((function({className:e}){return(0,r.jsxs)(ir,{className:e,children:[(0,r.jsx)(rr,{}),(0,r.jsx)(tr,{})]})})),ar=p.X.apiType.param,sr="json-rpc"===p.X.apiType.type&&"string"==typeof ar&&ar.startsWith("ws://"),lr="string"==typeof ar&&ar.includes("127.0.0.1"),cr=window.location.protocol.startsWith("https:"),dr=g.memo((function({className:e}){const{t:n}=Z(),{apiError:t,isApiConnected:i,isApiReady:o,isWaitingInjected:a}=(0,E.h)();return t?(0,r.jsx)(T,{className:e,icon:"globe",type:"error",children:(0,r.jsx)("div",{children:t})}):o?a?(0,r.jsx)(T,{className:e,icon:"puzzle-piece",type:"info",children:(0,r.jsx)("div",{children:n("Waiting for authorization from the extension. Please open the installed extension and approve or reject access.")})}):i?null:(0,r.jsxs)(T,{className:e,icon:"globe",type:"error",children:[(0,r.jsx)("div",{children:n("You are not connected to a node. Ensure that your node is running and that the Websocket endpoint is reachable.")}),sr&&!lr&&cr?(0,r.jsx)("div",{children:n("You are connecting from a secure location to an insecure WebSocket ({{wsUrl}}). Due to browser mixed-content security policies this connection type is not allowed. Change the RPC service to a secure 'wss' endpoint.",{replace:{wsUrl:ar}})}):void 0]}):(0,r.jsx)(T,{className:e,icon:"globe",type:"info",children:(0,r.jsx)("div",{children:n(i?"Waiting to complete metadata retrieval from remote endpoint.":"Waiting to establish a connection with the remote endpoint.")})})})),pr=g.memo((function(){const{api:e,apiIdentity:n,isApiReady:t}=(0,E.h)(),i=(0,ct.W7)(t&&e.derive.accounts?.indexes),o=(0,ct.W7)(t&&n.query.identity?.registrars),a=(0,ct.W7)(t&&e.query.balances?.totalIssuance),[s,l]=(0,g.useState)(!1);return(0,g.useEffect)((()=>{l(!!i||!!a||!!o)}),[]),(0,r.jsx)("div",{className:`apps--api-warm ${s.toString()}`})})),ur=N.zo.div`
  background: var(--bg-page);
  box-sizing: border-box;
  display: flex;
  flex-direction: column;
